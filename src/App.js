...
//  合约地址
const MYNFT_ADDRESS = "0x0b6f8EFE847736C492a8bcaA2bE832bF35a8a1b8";
const MARKET_ADDRESS = "0xefd2bAC78F3b7d0ffF8AfC79382BCd1054177EEa";
  ...
  {!account ? (
    ...
    <div className="content">
      <div className="account-info">
        <p>Connected as <span className="account-address">{account}</span></p>
      </div>
